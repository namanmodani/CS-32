//Generated:2021-12-16 20:48:24// 39-518
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_5982781 || '',
    GUID: window.ftGUID_5982781 || '99999999999',
    confID: window.ftConfID_5982781 || '0',
    ftReturn: window.ftReturn_5982781 || '',
    keyword: window.ftKeyword_5982781 || '',
    ftId: window.ftId_5982781 || '',
    imp: window.ftImp5982781,
    ftImpId: window.ftImp5982781 && window.ftImp5982781.impID || '',
    gdpr: window.ftImp5982781 && window.ftImp5982781.gdpr || '',
    gdpr_consent: window.ftImp5982781 && window.ftImp5982781.gdpr_consent || '',
    gdpr_pd: window.ftImp5982781 && window.ftImp5982781.gdpr_pd || '',
    us_privacy: window.ftImp5982781 && window.ftImp5982781.us_privacy || '',
    campaignID: '165067',
    cID: '137022',
    pID: '5982781',
    creativeID: '3733205',
    ...
    clickTags: [
      "http://servedby.flashtalking.com/click/8/165067;5982781;3733205;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://d.agkn.com/pixel/7422/?che=[FT_Random]&col=165067,17304,5982781,[FT_CONFID],3733205,[%FT_IMPRESSIONID%],[%FT_GUID%]&l1=https://www.disneyaulani.com/"
    ],
    placementDescription: 'AULDIS71027GOOGINCDDV3602021100120220930300X600MULFPRESACTMGNGMHDMENGSMDV360SimilarAudiencesPackage300x600D00094DI',
    width: 300,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    siteName: 'GoogleMarketingPlatform',
    divID: 'ftdiv5982781',
    phID: 'ftpos5982781',
    frameID: 'ftframe5982781',
    expID: 'ftexpframe5982781',
    altImgID: 'ftalt5982781',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/8/165067;5982781;3733205;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://d.agkn.com/pixel/7422/?che=[FT_Random]&col=165067,17304,5982781,[FT_CONFID],3733205,[%FT_IMPRESSIONID%],[%FT_GUID%]&l1=https://www.disneyaulani.com/',
    altImg: 'http://servedby.flashtalking.com/imp/8/165067;5982781;204;gif;GoogleMarketingPlatform;AULDIS71027GOOGINCDDV3602021100120220930300X600MULFPRESACTMGNGMHDMENGSMDV360SimilarAudiencesPackage300x600D00094DI/?',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/165067;5982781;271;pixel;GoogleMarketingPlatform;AULDIS71027GOOGINCDDV3602021100120220930300X600MULFPRESACTMGNGMHDMENGSMDV360SimilarAudiencesPackage300x600D00094DI/?',
    stump: 'http://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/598/5982781/3733205/js/j-5982781-3733205.js',
    file: 'http://cdn.flashtalking.com/137022/3733205/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?217079850-5982781;3733205;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_5982781 || '',
    segmentList: window.ftSegmentList_5982781 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp5982781 && window.ftImp5982781.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m5982781') && /^https:/.test(document.getElementById('ftscript_m5982781').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5982781'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_5982781'],
      ['ftcfid', 'ftConfID_5982781'],
      ['fttime', 'ftTimestamp_5982781'],
      ['ftsection', 'ftSection_5982781'],
      ['ftcustom', 'ftCustom_5982781'],
      ['ft_id', 'ftId_5982781'],
      ['ftimpid', 'ftImp5982781', 'impID'],
      ['gdpr', 'ftImp5982781', 'gdpr'],
      ['gdpr_consent', 'ftImp5982781', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp5982781', 'gdpr_pd'],
      ['us_privacy', 'ftImp5982781', 'us_privacy']
    ]
  };
  ...
  //--start extensions
ft5982781.encodeClickCount = 1;

ft5982781.addVClick = function(ct) {
    var o = this;
